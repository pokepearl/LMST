...
def startmpv():
    ...
    subprocess.Popen('mpv --idle --no-audio-display --no-video --no-input-terminal --input-ipc-server=/tmp/LMST-MPV-socket', shell=True, encoding='UTF-8',stdin=FNULL, stderr=FNULL, stdout=FNULL)
    time.sleep(2)
